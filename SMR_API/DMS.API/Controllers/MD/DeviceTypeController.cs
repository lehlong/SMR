...
namespace DMS.API.Controllers.MD
{
    ...
    {
        public readonly IDeviceTypeService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] DeviceTypeDto data)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] DeviceTypeDto data)
        {
            var transferObject = new TransferObject();
